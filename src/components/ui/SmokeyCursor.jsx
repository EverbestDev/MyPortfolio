...
export default function SmokeyCursor({
    ...
    `);
        ...
        function wrap(value, min, max) {
            const range = max - min; return range === 0 ? min : ((value - min) % range) + min;
        }
        ...
        function handleFirstMouseMove(e) {
            ...
            updateFrame(); updatePointerMoveData(pointer, posX, posY, generateColor());
        ...
        function handleFirstTouchStart(e) {
            ...
            for (let i = 0; i < touches.length; i++) {
                const posX = scaleByPixelRatio(touches[i].clientX); const posY = scaleByPixelRatio(touches[i].clientY);
        ...
        simulationResolution, dyeResolution, captureResolution, densityDissipation, velocityDissipation,
        pressure, pressureIterations, curl, splatRadius, splatForce, enableShading, colorUpdateSpeed,
