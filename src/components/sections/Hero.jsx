...
const Button = ({
  ...
  const primaryStyles = `border-2 border-[--neon-cyan] text-[--neon-cyan] hover:bg-[--neon-cyan]/20`; // Updated secondary button to have a strong, darker ghost appearance
  ...
  return (
    <motion.a
      href={href} // Increased padding and font weight, changed to rounded-xl for a tech aesthetic
      ...
      whileHover={{
        scale: 1.05,
        y: -2, // STRONGER NEON GLOW for primary button
        boxShadow: secondary
...
const Hero = () => {
  ...
  const opacity = useTransform(scrollY, [0, 300], [1, 0]); // State to track when the name typing is complete
  ...
  return (
    ...
    >
            <AnimatedGridBackground />      {/* FaultyTerminal with parallax */}
           {" "}
      <motion.div
        style={{
          width: "100%",
      ...
      >
        ...
        >
          ...
          >
            ...
                        with a passion for blending clean design with robust,
            scalable code. I             specialize in            {" "}
            <span style={{ color: NEON_CYAN, fontWeight: "600" }}>
                            MERN & MEVM            {" "}
            </span>{" "}
